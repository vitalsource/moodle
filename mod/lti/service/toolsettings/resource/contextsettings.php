 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class ltiresource_contextsettings extends ltiresource_base {
    ...
    public function execute($response) {
        ...
        if (!$ok) {
            ...
            if (!is_null($bubble)) {
                ...
                if ($bubble == 'distinct') {
                    ltiservice_toolsettings::distinct_settings($systemsettings, $contextsettings, null);
                }
            } else {
                $systemsettings = null;
            }
            if ($response->get_request_method() == 'GET') {
                ...
                $settings = ltiservice_toolsettings::settings_to_json($contextsettings, $simpleformat, 'ToolProxyBinding', $this);
